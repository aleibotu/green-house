...
import {Button, Card, Checkbox, Divider, Modal, Space, Typography, DatePicker} from "antd";
        ...
        <>
            <Card bodyStyle={{padding: 12,}}>
                <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    <Space>
                        <Button onClick={() => showModal()}>查看预估产量</Button>
                        <Button disabled>保存为我的方案</Button>
                    </Space>
                    <Space>
                        <Typography.Title level={2} style={{marginBottom: 0}}>$ 180,00000</Typography.Title>
                    </Space>
                </div>
            </Card>
            <Modal
